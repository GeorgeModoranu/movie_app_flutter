...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late Stream<List<MovieModel>> _getMovies;
  @override
  void initState() {
    super.initState();
    _getMovies = viewModel.allMovieModels();
  }
          ...
          StreamBuilder<List<MovieModel>>(
              ...
              builder: (context, snapshot) {
                ...
                return MovieSectionWidget(
                    title: "Popula Movies", movies: snapshot.requireData,toggleFavorite: viewModel.toggleFavorite);
              }),
          // Observer(builder: (context) {
